...
module.exports = {
	// Project Identity
	appName: 'minivaChild', // Unique name of your project
	type: 'theme', // Plugin or theme
	slug: 'miniva-child', // Plugin or Theme slug, basically the directory name under `wp-content/<themes|plugins>`
		...
		// If this has length === 1, then single compiler
		{
			...
			entry: {
		     ...
		     // global namespace pollutions 😉
				main: ['./src/theme/main.js'], // Or an array of string (string[])
			},
